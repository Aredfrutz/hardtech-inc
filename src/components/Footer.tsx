        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-black">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <div className="h-8 w-8 bg-black rounded-full flex items-center justify-center border border-primary">
                 <div className="w-4 h-4 bg-primary/20 rounded-full border border-primary" />
              </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-[10px] font-medium text-muted-foreground uppercase">
              ...
              <li><Link href="/forum" className="hover:text-primary transition-colors">Public Forum Services</Link></li>
